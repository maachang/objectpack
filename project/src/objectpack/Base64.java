...
public class Base64 {
	 ...
	 * デコード表.
	 */
	private static final int[] DEC_CD = { NOT_DEC, NOT_DEC, NOT_DEC, NOT_DEC, NOT_DEC, NOT_DEC, NOT_DEC, NOT_DEC,
			NOT_DEC, NOT_DEC, NOT_DEC, NOT_DEC, NOT_DEC, NOT_DEC, NOT_DEC, NOT_DEC, NOT_DEC, NOT_DEC, NOT_DEC, NOT_DEC,
			NOT_DEC, NOT_DEC, NOT_DEC, NOT_DEC, NOT_DEC, NOT_DEC, NOT_DEC, NOT_DEC, NOT_DEC, NOT_DEC, NOT_DEC, NOT_DEC,
			NOT_DEC, NOT_DEC, NOT_DEC, NOT_DEC, NOT_DEC, NOT_DEC, NOT_DEC, NOT_DEC, NOT_DEC, NOT_DEC, NOT_DEC,
			0x0000003e, NOT_DEC, NOT_DEC, NOT_DEC, 0x0000003f, 0x00000034, 0x00000035, 0x00000036, 0x00000037,
			0x00000038, 0x00000039, 0x0000003a, 0x0000003b, 0x0000003c, 0x0000003d, NOT_DEC, NOT_DEC, NOT_DEC,
			0x00000040, NOT_DEC, NOT_DEC, NOT_DEC, 0x00000000, 0x00000001, 0x00000002, 0x00000003, 0x00000004,
			0x00000005, 0x00000006, 0x00000007, 0x00000008, 0x00000009, 0x0000000a, 0x0000000b, 0x0000000c, 0x0000000d,
			0x0000000e, 0x0000000f, 0x00000010, 0x00000011, 0x00000012, 0x00000013, 0x00000014, 0x00000015, 0x00000016,
			0x00000017, 0x00000018, 0x00000019, NOT_DEC, NOT_DEC, NOT_DEC, NOT_DEC, NOT_DEC, NOT_DEC, 0x0000001a,
			0x0000001b, 0x0000001c, 0x0000001d, 0x0000001e, 0x0000001f, 0x00000020, 0x00000021, 0x00000022, 0x00000023,
			0x00000024, 0x00000025, 0x00000026, 0x00000027, 0x00000028, 0x00000029, 0x0000002a, 0x0000002b, 0x0000002c,
			0x0000002d, 0x0000002e, 0x0000002f, 0x00000030, 0x00000031, 0x00000032, 0x00000033, NOT_DEC, NOT_DEC,
			NOT_DEC, NOT_DEC, NOT_DEC, NOT_DEC, NOT_DEC, NOT_DEC, NOT_DEC, NOT_DEC, NOT_DEC, NOT_DEC, NOT_DEC, NOT_DEC,
			NOT_DEC, NOT_DEC, NOT_DEC, NOT_DEC, NOT_DEC, NOT_DEC, NOT_DEC, NOT_DEC, NOT_DEC, NOT_DEC, NOT_DEC, NOT_DEC,
			NOT_DEC, NOT_DEC, NOT_DEC, NOT_DEC, NOT_DEC, NOT_DEC, NOT_DEC, NOT_DEC, NOT_DEC, NOT_DEC, NOT_DEC, NOT_DEC,
			NOT_DEC, NOT_DEC, NOT_DEC, NOT_DEC, NOT_DEC, NOT_DEC, NOT_DEC, NOT_DEC, NOT_DEC, NOT_DEC, NOT_DEC, NOT_DEC,
	 ...
	 * @return byte[] Base64にエンコードされたバイナリ情報が返されます.
	 */
	public static final byte[] encodeBinary(final byte[] binary, final int off, final int length) {
		int i, j, k;
		int len;
		int etc;
		byte[] ary = null;
	 ...
	 * @return String Base64にエンコードされた文字情報が返されます.
	 */
	public static final String encode(final byte[] binary, final int off, final int len) {
		byte[] ary = encodeBinary(binary, off, len);
		String ret = BinaryUtils.toString(ary, 0, ary.length);
		ary = null;
		return ret;
	}
	 ...
	 * デコード処理.
	 * 
	 * @param base64 対象のBase64データを設定します.
